...
class CheckersAI():
    ...
    def give_command(self,state_list):#,color(used for testing)):
        ...
        if it is a legal move, takes that move and any captured piece positions and converts to world posiiqton index, which it returns.'''
        valid = False
        captured = []
        ...
        while not valid:
            start_in = input('Enter position of piece you want to move or q to quit: ')
            if start_in == 'q':
                print('Player quit')
                return None,None,None
            goal_in = input('Enter where you want to move the piece to: ')
...
class Board():
    ...
    def get_piece_count(self,state):
        ...
        # print(self.black_piece_count)
        # print(self.red_total)
        # print(self.black_total)
...
checkers = CheckersAI()
board = Board()
board_state = 'empty purple empty purple empty purple empty purple purple empty purple empty purple empty purple empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty green empty green empty green empty green green empty green empty green empty green empty'
color = 'purple'
# get_moves = test.get_moves(checkers.world_to_grid(board_state), color)
# minimax = test.minimax(board_state)
# piece_count = board.get_piece_count(board.world_to_grid(board_state))
# testing = CheckersAI()
# testing.give_command(board_state)

checkers.minimax(board_state)
